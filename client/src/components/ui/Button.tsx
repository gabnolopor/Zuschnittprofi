 ...
 * Incluye estado de carga y estilos consistentes
 */
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-gray-300 hover:bg-gray-50 text-gray-700 focus:ring-primary-500 disabled:bg-gray-50'
  };
